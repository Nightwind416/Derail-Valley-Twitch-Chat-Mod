...
namespace TwitchChat.Menus
{
    public static class UIElementFactory
    {
        ...
        public static Text CreateTextDisplay(Transform parent, string text, int xPosition, int yPosition, Color? textColor = null, int fontSize = 12)
        {
            GameObject textObj = new GameObject($"{text}TextDisplay");
        ...
        public static GameObject CreateHorizontalBar(Transform parent, int yPosition, Color? color = null)
        {
