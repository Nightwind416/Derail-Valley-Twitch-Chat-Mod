...
namespace TwitchChat.Menus
{
    public class NotificationMenu : BaseMenu
    {
        ...
        private void CreateNotificationSettingssSection()
        {
            ...
            // Enabled?
            UIElementFactory.CreateLabel(notificationSection.transform, "Toggle", 10, 10, Color.white);

            // Toggle button with value change listener
            notificationsEnabled = UIElementFactory.CreateToggle(notificationSection.transform, 90, 35, "Enabled", "Disabled", Settings.Instance.notificationsEnabled);
            ...
            // Duration
            UIElementFactory.CreateLabel(notificationSection.transform, "Duration", 10, 70, Color.white);
            
            // Duration slider
            notificationDuration = UIElementFactory.CreateSlider(notificationSection.transform, 0, 95, 1, 120, Settings.Instance.notificationDuration);
            ...
            UIElementFactory.CreateLabel(notificationSection.transform, "Min distance from boards", 10, 140, Color.white);
            ...
            UIElementFactory.CreateLabel(notificationSection.transform, "Limit number displayed", 10, 195, Color.white);
