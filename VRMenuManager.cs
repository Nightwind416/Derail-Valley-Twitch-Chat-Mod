...
//     {
//         private static VRMenuManager? instance;
...
//                 if (instance == null)
//                 {
//                     GameObject go = new("CustomVRMenuManager");
//                     instance = go.AddComponent<VRMenuManager>();
...
//             Main.LogEntry(methodName, "Initializing VRMenuManager");
//             CreateMenu();
//         }

//         private void Update()
//         {
//             if (Input.GetKeyDown(KeyCode.F8) || CheckVRPrimaryButton())
//             {
//                 string methodName = MethodBase.GetCurrentMethod().Name;
//                 Main.LogEntry(methodName, "VR Menu toggle triggered - toggling menu");
//                 ToggleMenu();
//             }

//             // Update menu position and text when visible
//             if (isMenuVisible)
//             {
//                 // PositionMenuInVR();
...
//         private bool CheckVRPrimaryButton()
//         {
...
//             if (device.isValid)
//             {
//                 device.TryGetFeatureValue(CommonUsages.primary2DAxisClick, out isPressed);
                
//                 // Check for button press and release to prevent repeated toggling
...
//             canvasRect.sizeDelta = new Vector2(100, 200);
...
//             Vector3 offset = targetObject.transform.forward * 0.3f; // Adjust distance as needed
//             menuCanvas.transform.position = targetPosition + offset;

//             // Match the rotation of the target object and add 90 degrees X rotation
//             menuCanvas.transform.rotation = targetObject.transform.rotation * Quaternion.Euler(90f, 0f, 50f);
//         }

//         private void PositionMenuInVR()
//         {
//             if (menuCanvas == null) return;

//             // Position the canvas in front of the player's view
//             Camera mainCamera = Camera.main;
//             if (mainCamera != null)
//             {
//                 Transform camTransform = mainCamera.transform;
//                 // float distance = XRSettings.enabled ? 1.5f : 2f; // Closer in VR
//                 float distance = 0.5f;
//                 menuCanvas.transform.position = camTransform.position + camTransform.forward * distance;
//                 menuCanvas.transform.rotation = camTransform.rotation;
//             }
//         }
